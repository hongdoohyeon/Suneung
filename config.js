...
export const CURRICULUM_CONFIG = {
  '2015': {
    ...
    subjects: {
      ...
      '직업탐구':  { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
                    subs: ['성공적인 직업생활','농업 기초 기술','공업 일반','상업 경제','수산·해운 산업 기초','인간 발달','생활 서비스 산업의 이해','해양의 이해'] },
  ...
  '2009': {
    ...
    subjects: {
      ...
      '직업탐구':  { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
                    subs: ['농업 이해','농업 기초 기술','공업 일반','기초 제도','상업 경제','회계 원리','수산·해운 산업 기초','인간 발달','농생명 산업','공업','상업 정보','수산·해운','가사·실업'] },
      '제2외국어': { icon: '🗣️', bg: '#f3e8ff', color: '#5a2ea8',
                    subs: ['독일어','러시아어','스페인어','아랍어','일본어','중국어','프랑스어','베트남어','한문'] },
    },
    subjectsByTypeGroup: {},
