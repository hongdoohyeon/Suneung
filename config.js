...
export const CURRICULUM_CONFIG = {
  ...
  '논술': {
    ...
    subjects: {
      ...
      '한양대학교':   { icon: '🦁', bg: '#e8f3fb', color: '#0e4a84', subs: [] },
      '경희대학교':   { icon: '🏛️', bg: '#fdf0ea', color: '#a03d18', subs: [] },
      '이화여자대학교': { icon: '🌸', bg: '#eaf7ec', color: '#00563f', subs: [] },
      '한국외국어대학교': { icon: '🌐', bg: '#f3efe6', color: '#7a5c1e', subs: [] },
      '서울시립대학교': { icon: '🏙️', bg: '#eef4fb', color: '#1b5faa', subs: [] },
      '건국대학교':   { icon: '🐮', bg: '#eaf5ec', color: '#046a38', subs: [] },
      '동국대학교':   { icon: '🐘', bg: '#fdf3e8', color: '#b06f0a', subs: [] },
      '숙명여자대학교': { icon: '🎓', bg: '#f0effb', color: '#3b3a8f', subs: [] },
      '인하대학교':   { icon: '⚓', bg: '#eaf2fb', color: '#19488f', subs: [] },
      '아주대학교':   { icon: '🚀', bg: '#eef2fa', color: '#1a3a7a', subs: [] },
    },
    subjectsByTypeGroup: {},
  },
