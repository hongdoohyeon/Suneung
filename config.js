...
const LEGACY_CURRICULUM_TO_TAB = {
  '2015': 'senior', '2009': 'senior',
  'pre2009': 'senior', '6차': 'senior', '7차': 'senior', '2007개정': 'senior',
  '예비': 'senior',
  '사관': 'mp', '경찰대': 'mp',
...
export const CURRICULUM_CONFIG = {
  '2015': {
    ...
    subjects: {
      ...
      '직업탐구':  { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
                    subs: ['성공적인 직업생활','농업 기초 기술','공업 일반','상업 경제','수산·해운 산업 기초','인간 발달'] },
      '제2외국어': { icon: '🗣️', bg: '#f3e8ff', color: '#5a2ea8',
                    subs: ['독일어','러시아어','스페인어','아랍어','일본어','중국어','프랑스어','베트남어','한문'] },
    },
    subjectsByTypeGroup: {},
  },
  ...
  '2009': {
    ...
    subjects: {
      ...
      '직업탐구':  { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
                    subs: ['농업 이해','농업 기초 기술','공업 일반','기초 제도','상업 경제','회계 원리','수산·해운 산업 기초','인간 발달','생활 서비스 산업의 이해','해양의 이해','농생명 산업','공업','상업 정보','수산·해운','가사·실업'] },
      '제2외국어': { icon: '🗣️', bg: '#f3e8ff', color: '#5a2ea8',
                    subs: ['독일어','러시아어','스페인어','아랍어','일본어','중국어','프랑스어','베트남어','한문'] },
    },
    subjectsByTypeGroup: {},
  ...
  // ── 7차 이전 시기를 교육과정별로 3분할 ──────────────────────
  // 데이터 분류 기준 (KICE 수능 적용 학년도):
  //   6차       : 1994~2004학년도 (1994는 1차/2차 분리, 1994~1998 일괄형 시험)
  //   7차       : 2005~2011학년도 (가/나/다형, 영역별 분리 본격화)
  //   2007개정 : 2012~2013학년도 (직전 2009개정으로 이행)
  // 영역명은 시기별로 일부 차이가 있으나 데이터에 등장하는 union 으로 노출.
  // subs 목록은 실제 data/exams.json 에 등장하는 subSubject 값 기준 — 정확 일치해야 필터·카운트가 동작.
  // 6차 (1994~2004) — 1994~1998 일괄형(인문계/자연계/예체능계), 1999~2004 영역 일부 분리.
  '6차': {
    id: '6차',
    label: '6차 교육과정',
    rangeLabel: '1994~2004학년도',
    gradeYearRange: [1994, 2004],
    availableTypeGroups: ['suneung'],
    subjects: {
      '국어':     { icon: '📖', bg: '#fff0e8', color: '#c44b00',
                   subs: ['1차','2차','인문계','자연계','예체능계'] },
      '수학':     { icon: '📐', bg: '#eef2ff', color: '#1a4fd6',
                   subs: ['가형','나형','인문계','자연계','예체능계','1차','2차'] },
      '영어':     { icon: '🌍', bg: '#e6f5fb', color: '#0077a8',
                   subs: ['1차','2차','인문계','자연계','예체능계'] },
      '사회탐구': { icon: '🌏', bg: '#ecf5e8', color: '#2a7a2a',
                   subs: ['인문계','경제','경제지리','국사','법과사회','사회·문화','세계사','세계지리','윤리','정치','한국근현대사','한국지리'] },
      '과학탐구': { icon: '🔬', bg: '#f0e8ff', color: '#6b2fbe',
                   subs: ['자연계','물리Ⅰ','물리Ⅱ','화학Ⅰ','화학Ⅱ','생명과학Ⅰ','생명과학Ⅱ','지구과학Ⅰ','지구과학Ⅱ'] },
    },
    subjectsByTypeGroup: {},
  },

  // 7차 (2005~2011) — 가/나형, 영역별 분리 본격화. 한국사가 사회탐구 하위에 포함.
  '7차': {
    id: '7차',
    label: '7차 교육과정',
    ...
    subjects: {
      ...
      '영어':       { icon: '🌍', bg: '#e6f5fb', color: '#0077a8', subs: ['듣기대본'] },
      '사회탐구':   { icon: '🌏', bg: '#ecf5e8', color: '#2a7a2a',
                     subs: ['경제','경제지리','국사','법과사회','사회·문화','세계사','세계지리','윤리','정치','한국근현대사','한국사','한국지리'] },
      '과학탐구':   { icon: '🔬', bg: '#f0e8ff', color: '#6b2fbe',
                     subs: ['물리Ⅰ','물리Ⅱ','화학Ⅰ','화학Ⅱ','생명과학Ⅰ','생명과학Ⅱ','지구과학Ⅰ','지구과학Ⅱ'] },
      // 직업탐구·제2외국어 — 데이터 기준 띄어쓰기 그대로 (build-data 단계에서 정규화하지 않음).
      '직업탐구':   { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
  ...
  // 2007개정 (2012~2013) — 7차와 거의 동일 영역, 09개정 직전 과도기.
  '2007개정': {
    id: '2007개정',
    label: '2007 개정',
    ...
    subjects: {
      ...
      '영어':       { icon: '🌍', bg: '#e6f5fb', color: '#0077a8', subs: [] },
      '사회탐구':   { icon: '🌏', bg: '#ecf5e8', color: '#2a7a2a',
                     subs: ['경제','경제지리','국사','법과사회','사회·문화','세계사','세계지리','윤리','정치','한국근현대사','한국지리'] },
      '과학탐구':   { icon: '🔬', bg: '#f0e8ff', color: '#6b2fbe',
                     subs: ['물리Ⅰ','물리Ⅱ','화학Ⅰ','화학Ⅱ','생명과학Ⅰ','생명과학Ⅱ','지구과학Ⅰ','지구과학Ⅱ'] },
      '직업탐구':   { icon: '🛠️', bg: '#fff7e0', color: '#a06b00',
                     subs: ['기초 제도','농업 기초 기술','농업 이해','상업 경제','인간 발달','회계 원리'] },
  ...
  '논술': {
    ...
    subjects: {
      ...
      '연세대학교':   { icon: '🦅', bg: '#e8efff', color: '#003876', subs: ['인문', '자연'] },
      '서강대학교':   { icon: '📕', bg: '#fdeeee', color: '#a6192e', subs: ['인문', '자연'] },
      '성균관대학교': { icon: '🌳', bg: '#eaf7ee', color: '#0b6e4f', subs: ['인문', '자연'] },
      '중앙대학교':   { icon: '🐉', bg: '#eef3fb', color: '#0a4595', subs: ['인문', '자연'] },
      '한양대학교':   { icon: '🦁', bg: '#e8f3fb', color: '#0e4a84', subs: ['인문', '자연'] },
      '경희대학교':   { icon: '🏛️', bg: '#fdf0ea', color: '#a03d18', subs: ['인문', '자연'] },
      '이화여자대학교': { icon: '🌸', bg: '#eaf7ec', color: '#00563f', subs: ['인문', '자연'] },
      '한국외국어대학교': { icon: '🌐', bg: '#f3efe6', color: '#7a5c1e', subs: ['인문', '자연'] },
      '서울시립대학교': { icon: '🏙️', bg: '#eef4fb', color: '#1b5faa', subs: ['인문', '자연'] },
      '건국대학교':   { icon: '🐮', bg: '#eaf5ec', color: '#046a38', subs: ['인문', '자연'] },
      '동국대학교':   { icon: '🐘', bg: '#fdf3e8', color: '#b06f0a', subs: ['인문', '자연'] },
      '숙명여자대학교': { icon: '🎓', bg: '#f0effb', color: '#3b3a8f', subs: ['인문', '자연'] },
      '인하대학교':   { icon: '⚓', bg: '#eaf2fb', color: '#19488f', subs: ['인문', '자연'] },
      '아주대학교':   { icon: '🚀', bg: '#eef2fa', color: '#1a3a7a', subs: ['인문', '자연'] },
      '가톨릭대학교': { icon: '✝️', bg: '#f3eefa', color: '#5b2d8e', subs: ['인문', '자연'] },
      '홍익대학교':   { icon: '🎨', bg: '#eef4fb', color: '#0c2e6e', subs: ['인문', '자연'] },
      '단국대학교':   { icon: '🐻', bg: '#eef3fa', color: '#16418a', subs: ['인문', '자연'] },
      '세종대학교':   { icon: '👑', bg: '#fbeeee', color: '#8e2424', subs: ['인문', '자연'] },
      '광운대학교':   { icon: '💡', bg: '#fdf3ea', color: '#9a4b08', subs: ['인문', '자연'] },
      '숭실대학교':   { icon: '⛪', bg: '#eef6f4', color: '#0b5c50', subs: ['인문', '자연'] },
      '서울여자대학교': { icon: '🌷', bg: '#fbeef4', color: '#94275e', subs: ['인문', '자연'] },
      '성신여자대학교': { icon: '🦢', bg: '#eef2fb', color: '#27408f', subs: ['인문', '자연'] },
      '부산대학교':   { icon: '🌊', bg: '#eaf3fb', color: '#0d4f8b', subs: ['인문', '자연'] },
      '경북대학교':   { icon: '🏔️', bg: '#f0eefa', color: '#503093', subs: ['인문', '자연'] },
      '가천대학교':   { icon: '🩺', bg: '#eaf6fb', color: '#0a6e9e', subs: ['인문', '자연'] },
      '경기대학교':   { icon: '🏰', bg: '#f4f0ea', color: '#74591f', subs: ['인문', '자연'] },
      ...
      '동덕여자대학교': { icon: '🌺', bg: '#fbeef2', color: '#a02950', subs: ['인문', '자연'] },
      '을지대학교':   { icon: '🏥', bg: '#e9f6f2', color: '#0a6b54', subs: ['인문', '자연'] },
      '한국공학대학교': { icon: '⚙️', bg: '#eef2f7', color: '#2d4a6b', subs: ['인문', '자연'] },
  ...
  '고졸': {
    ...
    gradeYearRange: [2013, 2026],
    availableTypeGroups: ['ged'],
    subjects: {
      '전과목':    { icon: '📚', bg: '#eef2f7', color: '#475569', subs: [] },
      '국어':      { icon: '📖', bg: '#fff0e8', color: '#c44b00', subs: [] },
      '수학':      { icon: '📐', bg: '#eef2ff', color: '#1a4fd6', subs: [] },
      '영어':      { icon: '🌍', bg: '#e6f5fb', color: '#0077a8', subs: [] },
...
export const EXAM_TYPE_CONFIG = [
  ...
  // (3) 영역색과 hue 충돌 회피: 교육청 = 슬레이트 (보라X), 사관 = 다크 브론즈 (한국사와 분리).
  {
    ...
    types: [
      ...
      { key: 'june',   label: '6모',      month:  6, badgeBg: '#e6f0fa', badgeColor: '#0066cc' },
      { key: 'sept',   label: '9모',      month:  9, badgeBg: '#e6f0fa', badgeColor: '#0066cc' },
...
// 검색 별칭: 사용자 축약·은어 → 실제 데이터 키 (토큰 단위로 매칭)
...
// 알려진 alias key 목록 — 긴 것부터 정렬 (greedy split 용).
// "9모영어" 같은 합성 토큰을 ["9모","영어"] 로 분해할 때 사용.
export const ALIAS_KEYS_DESC = Object.keys(SEARCH_ALIASES)
