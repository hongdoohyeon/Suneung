'use strict';
import { CURRICULUM_CONFIG, getTypeConf, prettySub, legacyTabKey } from './config.js?v=884ab5bc0bbc611d10d5';
import { $, escHtml, escAttr, safeUrl } from './lib/dom.js?v=884ab5bc0bbc611d10d5';
import { setMeta, setMetaProp, setCanonical, injectJsonLd as _injectJsonLd } from './lib/seo.js?v=884ab5bc0bbc611d10d5';
...
async function main() {
  ...
  const sources = [`data/set/${stem}.json?v=20260801a`, 'data/exams.json?v=884ab5bc0bbc611d10d5'];
