...
export async function loadAdmissionsData() {
  ...
  try {
    const [ratios, results, supported] = await Promise.all([
      fetch('data/admissions/manual-ratios.json?v=a6b6ab6506349e096537').then(r => r.json()),
      fetch('data/admissions/manual-results.json?v=a6b6ab6506349e096537').then(r => r.json()),
      fetch('data/admissions/supported-universities.json?v=a6b6ab6506349e096537')
