...
export async function loadAdmissionsData() {
  ...
  try {
    const [ratios, results, supported] = await Promise.all([
      fetch('data/admissions/manual-ratios.json?v=a758c824dc29a7890187').then(r => r.json()),
      fetch('data/admissions/manual-results.json?v=a758c824dc29a7890187').then(r => r.json()),
      fetch('data/admissions/supported-universities.json?v=a758c824dc29a7890187')
