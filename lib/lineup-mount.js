...
import { buildLineup, loadAdmissionsData } from './lineup.js?v=20260508o';
...
function ensureSection() {
  ...
  sec.innerHTML = `
    ...
    <div class="lineup-filters" id="lineupFilters">
      ...
      <button class="lineup-filter is-active" data-line="risky" type="button"><span class="lineup-dot" style="background:#888"></span>지원 어려움</button>
    </div>
