#!/usr/bin/env python3
"""Phase 2 batch 21 — 가톨릭·숙명 23 에듀진."""
import json
...
CATHOLIC_2023 = [
    ('의예과', 99.5), ('약학과', 96.83),
    ('간호학과 (자연)', 88.0), ('의생명과학과', 85.33),
]

SOOKMYUNG_2023 = [
    ('약학부', 96.25), ('경제학부', 84.75),
]
...
merge('catholic',  '2023', CATHOLIC_2023)
merge('sookmyung', '2023', SOOKMYUNG_2023)

F.write_text(json.dumps(r, ensure_ascii=False, indent=2), encoding='utf-8')

total = len(CATHOLIC_2023) + len(SOOKMYUNG_2023)
print(f'Phase 2 batch 21 — 2 / {total}개 학과')
